...
public:
	...
	// для того что бы работало в танке враге, тут оно так как этот класс наследуется от павна, а дочерние от него
	...
	// это угол меньше которого пушка начнет стрелять - это в функции Targeting
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Fire Params")
		float AimSlack = 15;
